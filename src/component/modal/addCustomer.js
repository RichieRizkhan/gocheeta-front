         ...
         >
             ...
             <Modal.Body>
                 ...
                 <Form onSubmit={handleSubmit}>
                         ...
                         <Form.Group as={Col} controlId="formGridTerminalSerial" className="mb-3">
                             <Form.Control  name="fullName" type="text" placeholder="full name" onChange={handleChange} required />
                         </Form.Group>
                         <Form.Group as={Col} controlId="formGridTerminalSerial" className="mb-3">
                         ...
                         <Form.Group as={Col} controlId="formGridTerminalSerial" className="mb-3">
                             <Form.Control  name="telephone" type="text" placeholder="telephone" onChange={handleChange} required />
                         </Form.Group>
