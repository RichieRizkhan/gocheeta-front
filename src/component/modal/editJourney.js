             ...
             <Modal.Body>
                 ...
                 <Form onSubmit={handleSubmit}>
                         <Form.Group as={Col} controlId="formGridTerminalSerial" className="mb-3">
                             <Form.Control value={props.editData.pickup}  name="pickup" type="text" placeholder="pickup" onChange={handleChange} required />
                         </Form.Group>
                         <Form.Group as={Col} controlId="formGridTerminalSerial" className="mb-3">
                             <Form.Control value={props.editData.destination}  name="destination" type="text" placeholder="destination" onChange={handleChange} required />
                         </Form.Group>
                         <Form.Group as={Col} controlId="formGridTerminalSerial" className="mb-3">
                             <Form.Control value={props.editData.distance}  name="distance" type="number" placeholder="distance (km)" onChange={handleChange} required />
                         </Form.Group>
                         <Form.Group as={Col} controlId="formGridTerminalSerial" className="mb-3">
                             <Form.Select defaultValue={props.editData.type}  name="type" type="email" placeholder="type" onChange={(e)=>{
                         ...
                         <Form.Group as={Col} controlId="formGridTerminalSerial" className="mb-3">
                             <Form.Select defaultValue={props.editData.vehicle} name="vehicle" type="email" placeholder="type" onChange={handleChange} required >
