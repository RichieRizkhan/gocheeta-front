             ...
             <Modal.Body>
                 ...
                 <Form onSubmit={handleSubmit}>
                         ...
                         <Form.Group as={Col} controlId="formGridTerminalSerial" className="mb-3">
                             ...
                             <option value="" defaultValue={props.editData.type} hidden>Select Vehicle Type</option>
                         ...
                         <Form.Group as={Col} controlId="formGridTerminalSerial" className="mb-3">
                             <Form.Control  value={props.editData.numberplate} name="numberPlate" type="text" placeholder="number Plate" onChange={handleChange} required />
                         </Form.Group>
                         <Form.Group as={Col} controlId="formGridTerminalSerial" className="mb-3">
                             <Form.Select name="driver" onChange={handleChange} required defaultValue={props.editData.driver}>
